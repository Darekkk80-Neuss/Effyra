# NEXA – Zusammenfassung

**Stand:** Juli 2026 · **Live:** https://darekkk80-neuss.github.io/Nexa/ · **Repo:** [Darekkk80-Neuss/Nexa](https://github.com/Darekkk80-Neuss/Nexa)
...
| Bereich | Was es kann |
|---|---|
| 📄 **Dokumente** | Brief/Rechnung/Vertrag fotografieren → NEXA erklärt ihn in einfachen Worten, erkennt Fristen, schlägt Aufgaben vor, formuliert einen Antwortentwurf |
...
> ⚠️ **Ehrlicher Hinweis:** Da NEXA ohne Server läuft, ist die Sperre eine **Komfort-Sperre, kein echter Schutz** – technisch versierte Nutzer könnten sie umgehen. Für die aktuelle Prototyp-Phase ist das ausreichend und üblich.
...
`gh api -X POST repos/Darekkk80-Neuss/Nexa/pages/builds`
