...
begin
  ...
  if eff = 'premium'
    ...
    v_via := true;
    select f.plan_until into v_fam_until
      from public.family_members fm
...
-- ------------------------------------------------------------
-- 4) consume_ai() neu: Premium-Gate über effective_tier (Familie zählt jetzt mit).
--    Zähler/Kontingent laufen weiterhin auf dem EIGENEN Profil des Nutzers.
